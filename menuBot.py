...
m_games = Menu("Игры", buttons=["Виселица", "Выход"], module="game", parent=m_main)
m_fun = Menu("Развлечения", buttons=["Прислать собаку", "Имя", "Прислать анекдот",  "Выход"], parent=m_main, module="main")
